...
class TexecomConnect(object):
    ...
    def sendcommand(self, cmd, body):
        ...
        while retries > 0:
            ...
            try:
                ...
                self.log("msg Timeout waiting for response, resending last command")
    ...
    def get_date_time(self):
        ...
        self.log("msg Panel date/time: " + datetimestr + diff)
        return datetimestr
    ...
    def get_lcd_display(self):
        ...
        if len(lcddisplay) != 32:
            ...
            return None
        self.log("msg Panel LCD display: " + lcddisplay)
        return lcddisplay
    ...
    def get_log_pointer(self):
        ...
        self.log("msg Log pointer: {:d}".format(logpointer))
        return logpointer
    ...
    def get_panel_identification(self):
        ...
        if len(panelid) != 32:
            ...
            return None
        self.log("msg Panel identification: " + panelid)
        return panelid
    ...
    def get_system_power(self):
        ...
        self.log("msg System power: system voltage {:f} battery voltage {:f} system current {:d} battery current {:d}".
    ...
    def event_loop(self):
        ...
        while True:
            ...
            self.get_site_data()
            self.log("msg Got all areas/zones/users; waiting for events")
    ...
    def decode_message_to_text(self, payload):
        ...
        if msg_type == self.MSG_DEBUG:
            ...
            return "msg Zone event message: zone {:d} '{}' {}". \
...
if __name__ == '__main__':
    texhost = os.getenv('TEXHOST','192.168.1.174')
